...
const badgeVariants = cva(
  "inline-flex items-center rounded-full border px-3 py-1 sm:px-2.5 sm:py-0.5 text-xs sm:text-xs font-semibold transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2",
  {
    variants: {
      variant: {
